...
def max(list):
    ...
    #use list[1:] b/c in the next line of code we set up a comparison with the first value of list (list[0]) and compare this value to the rest of the list
    #remember: D&C is about moving closer to an empty array with each recursive call 
    sub_max = max(list[1:])
